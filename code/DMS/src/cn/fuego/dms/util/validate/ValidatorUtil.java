 ...
 * @version V1.0   
 */
package cn.fuego.dms.util.validate;
...
public class ValidatorUtil
{
	...
	public static boolean validChinese(char c)// 校验输入为中文字符
	{
		...
		if (ub == Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS || ub == Character.UnicodeBlock.CJK_COMPATIBILITY_FORMS || ub == Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A)
		{
			return true;
		}
		else
